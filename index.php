...
?>
	...
	<div id="footer"><center><table><tr><td> <a href="https://github.com/sosprz/nettemp">NEW NETTEMP</a> </td><td>Donate for developing</td><td> <?php include('modules/info/paypal.php'); ?></td><td>v <?php passthru("awk '/Changelog/{y=1;next}y' readme.md |head -2 |grep -v '^$' && /usr/bin/git branch |grep [*]|awk '{print $2}';"); ?></td><td>| System time <?php $today=date("H:i:s"); echo $today;?></td></tr></table></center>
</div>
</div>
<center>
</center>
